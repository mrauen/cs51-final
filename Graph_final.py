...
class Edge:
  def __init__ (self, neighbor_item = None, list_of_diffs = None, mean_of_diffs = None, stdev = None, num_ratings = None, conf = None):
		...
		if conf is None:	
			conf = 0
		self.neighbor_item = neighbor_item
...
class Item:
	...
	def neighbors_list (self):
		return [x.neighbor_item for x in self.edge_list]
